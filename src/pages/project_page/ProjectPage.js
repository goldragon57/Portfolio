                            ...
                            >
                              <div className="projectContent">
                                ...
                                <div className="project--showcaseBtn">
                                  <a
                                    href={
                                      "https://code-converter-brown.vercel.app/"
                                    }
                                    target="_blank"
                                    rel="noreferrer"
                                    className={"iconBtn"}
                        ...
                        <Col md={3} className="col-sm-12 col-md-4">
                          <Fade bottom>
                            ...
                            >
                              ...
                              >
                                React, Typescript, NodeJS, ExpressJS, Redis, AI
                              </div>
                            </div>
                          </Fade>
                        </Col>
                          ...
                          <Fade bottom>
                            ...
                            >
                              <div className="projectPageContent">
                                ...
                                <img src={aroma} alt={aroma} />
                                <div className="project--showcaseBtn">
                                  <a
                                    href={
                                      "https://aroma-zomato.vercel.app/"
                                    }
                                    target="_blank"
                                    rel="noreferrer"
                                    className={"iconBtn"}
                              ...
                              >
                                Wordpress, MySQL, PHP, CSS, JavaScript
                              </div>
                            </div>
                          </Fade>
                        </Col>
